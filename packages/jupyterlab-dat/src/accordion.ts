// copied from https://raw.githubusercontent.com/jupyter-widgets/ipywidgets/1f93ad39802d3ee4a6b88bc13064f93f8f796374/packages/controls/src/phosphor/accordion.ts
...
import { DatSidebarHeader } from './header';
...
export class Collapse extends Widget {
  constructor(options: Collapse.IOptions) {
    ...
    this._header = new DatSidebarHeader({
      manager: options.datManager,
...
export class Accordion extends Panel {
  ...
  */
  ...
  private _wrapWidget(widget: Widget) {
    let collapse = new Collapse({ widget, datManager: this._datManager });
